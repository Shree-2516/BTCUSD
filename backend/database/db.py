...
Index("ix_trades_scaling_query", Trade.symbol, Trade.trade_type, Trade.entry_time)
...
class CachedPrediction(Base):
    ...
    horizon = Column(String, index=True) # DAILY, WEEKLY, MONTHLY
    prediction_data = Column(Text) # JSON string of prediction payload
