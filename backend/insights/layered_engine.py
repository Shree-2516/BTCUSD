...
from backend.utils.groq_client import groq_sentiment
from backend.utils.orderbook_analyzer import orderbook_analyzer
from backend.insights.regime_detector import regime_detector
    ...
    def load_legacy_models(self):
        ...
        try:
            ...
            if os.path.exists('models/lightgbm_model.pkl'):
                ...
                try:
                    import lightgbm
                    self.lgbm_model = joblib.load(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'models', 'lightgbm_model.pkl'))
